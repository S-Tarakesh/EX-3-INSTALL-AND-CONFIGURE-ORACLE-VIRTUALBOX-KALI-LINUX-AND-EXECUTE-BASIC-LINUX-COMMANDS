...
## Part A – Installing Oracle VirtualBox
Step 1
...
## Part C – Creating a Virtual Machine
Step 1
Open VirtualBox.
...
## Part D – Installing Kali Linux
1.	Select Graphical Install. 
2.	Choose the language. 
3.	Select the region. 
4.	Create a username. 
5.	Create a password. 
6.	Configure the disk partition. 
